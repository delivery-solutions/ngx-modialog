...
import { DialogRef, ModalComponent, CloseGuard } from '@deliverysolutions/ngx-modialog';
import { BSModalContext } from '@deliverysolutions/ngx-modialog/plugins/bootstrap';
