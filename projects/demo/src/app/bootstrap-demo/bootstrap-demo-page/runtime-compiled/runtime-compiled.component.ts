...
import { DialogRef, overlayConfigFactory } from "@deliverysolutions/ngx-modialog";
import { Modal, BSModalContext } from '@deliverysolutions/ngx-modialog/plugins/bootstrap';
